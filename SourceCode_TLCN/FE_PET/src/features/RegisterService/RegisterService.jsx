    ...
    <div className="RegisterService">
      ...
      <Container>
        <Container className="content">
          <div className="title">
            <div className="title_header" style={{ marginBottom: '10px' }}>
              ĐẶT LỊCH NHANH
            </div>
            <small className="title_small">Đăng ký ngay để nhận nhiều ưu đãi nóng.</small>
          </div>
          <div className="form">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="input-admin">
                ...
                {serviceDefault != null ? <Select closeMenuOnSelect={false} defaultValue={serviceDefault} onChange={onchangeTypeService} options={data} /> : ''}
              </div>
              <div className="input-admin">
                <label htmlFor="">Loại thú cưng</label>
                <Select closeMenuOnSelect={false} onChange={onchangeTypePet} defaultValue={[{ value: 'chó', label: 'chó' }]} options={dataType} />
              </div>
              <div className="input-admin">
                <label htmlFor="">Trọng lượng</label>
                <Select closeMenuOnSelect={false} onChange={onchangeWeight} defaultValue={[{ value: 1, label: '15kg - 20kg' }]} options={weight} />
              </div>
              ...
              <small className="title_small">Bạn sẽ sớm nhận được liện hệ từ đội ngũ nhân viên của chúng tôi. Xin cảm ơn!</small>
            </form>
          </div>
        </Container>
      </Container>
