              ...
              <div className="grand">
                ...
                <div className="content">
                  {categoryData?.map((ok, index) => (
                    <div className="item" onClick={() => onChangeCategory(ok.name)} key={index}>
                      {ok.name}
                    </div>
                  ))}
                </div>
                  ...
                  <div className="item-pet">
                    <Link to={`${path}/${petOrProduct}/${ok.id}`}>
                      <div className="img">
                        ...
                        <div className="add-cart" onClick={() => handleAddCart(ok)}>
                          Thêm vào giỏ
                        </div>
                    ...
                    <div className="name">
                      <Link to={`${path}/${petOrProduct}/${ok.id}`}>{ok.name}</Link>
                    </div>
                    <div className="price">
