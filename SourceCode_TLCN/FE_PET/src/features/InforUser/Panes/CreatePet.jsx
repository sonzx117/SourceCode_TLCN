        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="input-admin">
            ...
            <div className="update">
              ...
              {linkImgPet ? (
                <img loading="lazy" src={linkImgPet} className="img-update" height="150px" width="250px" alt="" />
              ) : imgIdPet ? (
                <img loading="lazy" src={imgIdPet} className="img-update" height="150px" width="250px" alt="" />
              ) : (
                ''
              )}
              <br />
          ...
          <div className="input-admin">
            ...
            <Select closeMenuOnSelect={false} onChange={onchangeType} options={dataType} />
          </div>
          <div className="input-admin">
