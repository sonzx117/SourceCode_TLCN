...
import { removeListCart, updateListCart } from '../../../app/Slice/CartSlide';
...
export default function Cart() {
  ...
  return (
    <div className="cart">
      ...
      {userInfor && <Payment statusDialog={statusDialog} onClose={handleCloseDialog} userInfor={userInfor} listCart={listCart} />}
      <Drawer key="12" anchor="right" open={toggleDrawer} onClose={() => setToggleDrawer(!toggleDrawer)}>
        <div className="cart-content">
          ...
          <div className="content">
            <div className="content-header">
              ...
              <div className="st">Tổng tiền</div>
            ...
            {listCart?.map((ok, index) => (
              <div className="content-product" key={index}>
                ...
                <div className="tt" onClick={() => handleDelete(ok.id)} style={{ cursor: 'pointer' }}>
                  Xoá
                </div>
              </div>
            ))}
