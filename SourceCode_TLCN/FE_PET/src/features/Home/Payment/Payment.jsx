    ...
    <div className="payment">
      <Dialog open={statusDialog} onClose={handleClose} aria-labelledby="form-dialog-title">
              ...
              {listCart?.map((ok, index) => (
                <div className="box" key={index}>
                  ...
                  <div className="box_content">
                    ...
                    <div className="item">Giá: {Number(ok.priceResult).toLocaleString()} vnđ</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-slide-description">Bạn đồng ý tiếp tục tiến hành giao dịch? Bạn không thể huỷ giao dịch khi đã bấm tiếp tục.</DialogContentText>
          </DialogContent>
          <DialogActions>
