...
export default function Menu({ user, setUserMenu }) {
  ...
  const avatarDefault = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTWalCQZajCWwnxKEE86RcbGh2i1XxEQ9Jkxt6ijNjm1CrvdnYilpInfHHVeriUng58IBo&usqp=CAU';
    ...
    <div className="Menu" ref={MenuEl}>
      ...
      <div id="menu-hide" ref={MenuHidentEl} style={{ display: 'flex' }}>
        ...
        <div className="menu-account">
          ...
          <div className={`select ${openSelect}`} style={{ display: `${initSelect}` }} ref={selectEL}>
            {user.length === 0 ? (
              <ul>
                <li>
